...
export default function MythicalGrowthManager() {
  ...
  const sortedInvestments = useMemo(() => [...investments].sort((a, b) => a.title.localeCompare(b.title)), [investments]);
